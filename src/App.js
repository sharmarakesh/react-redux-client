...
class App extends Component {
  ...
  render() {
    return (
      ...
      <div style={{ display: "flex", justifyContent: 'space-between', alignItems: 'center', padding: '0 20px', height: '50px' }}>
      <div>
      ...
      <div style={{ display: "flex", justifyContent: 'flex-end', alignItems: 'center' }}>
        <KeyboardDatePicker label="Start Date" selectedDate={this.state.startDate} changed={this.handleStartDateChange}></KeyboardDatePicker>
        <KeyboardDatePicker label="End Date" selectedDate={this.state.endDate} changed={this.handleEndDateChange}></KeyboardDatePicker>
